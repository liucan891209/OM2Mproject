...
import org.eclipse.om2m.testmnside.monitor.NMEA.GPSPosition;
import org.eclipse.om2m.testmnside.monitor.NMEA.SentenceParser;
...
//				NMEA gps = new NMEA();
//				GPSPosition utilposition = gps.parse(gpsdata.main());
//				sensorValue = utilposition.toString();
